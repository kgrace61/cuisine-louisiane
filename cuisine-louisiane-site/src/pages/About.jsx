...
export default function About() {
  return (
    <div className="px-6 md:px-16 lg:px-[2in] pt-6 md:pt-[1in] font-sans">
      <div className="flex flex-col space-y-8">
        ...
        <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-4">
          ...
          />
          <p className="text-center md:w-1/2 font-julius text-lg md:ml-4">
        ...
        <div className="text-center space-y-4 pb-[1in]">
          <p className="w-full md:w-6/7 mx-auto font-julius text-xl">
