    ...
    <div className="px-[2in] pt-[1in] font-sans">
      <div className="flex flex-col space-y-8">
        ...
        <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-4">
          <img src={chafing} alt="Description of image 1" className="w-full md:w-1/2 h-auto" />
          <p className="text-center md:w-1/2 font-julius">
        ...
        <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-4">
          <p className="text-center md:w-1/2 order-2 md:order-1 font-julius">
          ...
          <img src={crawfish} alt="Description of image 2" className="w-full md:w-1/2 h-auto order-1 md:order-2" />
        </div>

        {/* Third Row: Two centered paragraphs */}
        <div className="text-center space-y-4 pb-[1in]">
          <p className="w-full md:w-5/6 mx-auto font-julius text-lg">
